    ...
    <main id="main-content">
      <div className="usa-section">
        <GridContainer className="usa-prose">
          ...
          <p>
            Welcome to this prototype. This template repository demonstrates how
            to integrate Next.js, Storybook, and the U.S. Web Design System
            (USWDS) using the Trussworks React component library. We hope this
            setup helps other developers build accessible, scalable, and
            well-documented applications more efficiently.
          </p>
